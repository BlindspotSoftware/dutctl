...
// StreamForClient satisfies it, and a test can substitute a recording fake.
...
func (m *clientFileTransferManager) sendUploadInChunks(transferID, path string, file *os.File, stream chunkStream) {
	go func() {
		defer file.Close()
