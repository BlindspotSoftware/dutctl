...
// (see [github.com/BlindspotSoftware/dutctl/pkg/keyword.CommandKeywords] and
// [github.com/BlindspotSoftware/dutctl/pkg/keyword.DeviceKeywords]). A module command
