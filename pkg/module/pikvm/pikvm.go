...
func (p *PiKVM) Help() string {
	...
	case cmdTypeKeyboard:
		writeKeyboardHelp(&help)
	case cmdTypeMedia:
		writeMediaHelp(&help)
	case cmdTypeScreenshot:
		writeScreenshotHelp(&help)
	default:
		writePowerHelp(&help)
		writeKeyboardHelp(&help)
		writeMediaHelp(&help)
...
func writePowerHelp(help *strings.Builder) {
...
func writeKeyboardHelp(help *strings.Builder) {
...
func writeMediaHelp(help *strings.Builder) {
...
func writeScreenshotHelp(help *strings.Builder) {
