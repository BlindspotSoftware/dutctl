...
* the -force flag is removed; use "dutctl <device> unlock force" to break a lock held by another user.
...
* add Gude PDU support via pluggable vendor backends ([15fdd24](https://github.com/BlindspotSoftware/dutctl/commit/15fdd24d7367b174209272f3df5fae6fa8ef6f4b))
...
* add structured logging to dutagent and dutserver ([311b765](https://github.com/BlindspotSoftware/dutctl/commit/311b765c93a074cd5acd3ddef85bb70d8cacac6c))
* add systemd service ([377e47e](https://github.com/BlindspotSoftware/dutctl/commit/377e47e6dc57b46454279ee80155ef2c761a4af9))
* add wifi socket module ([329161d](https://github.com/BlindspotSoftware/dutctl/commit/329161d5b3834edc5b871741e5feea059a350b48))
* agent and client verify dutctl versions ([20e5d70](https://github.com/BlindspotSoftware/dutctl/commit/20e5d70907efda22554bb00696a5ad331fd05b75))
...
* apply an agent default lock duration and nudge cooperative use ([0749886](https://github.com/BlindspotSoftware/dutctl/commit/0749886dd892f4ec35cc467c3ebec805e66d741e))
* bound client RPCs with a signal-aware per-call deadline ([f760ca3](https://github.com/BlindspotSoftware/dutctl/commit/f760ca36738bcf2e5ee3ab3f506f6e013c2eb0f6))
* consolidate reserved keywords into internal/keyword ([c614f79](https://github.com/BlindspotSoftware/dutctl/commit/c614f79a6b4fac30da8dfcf45308d1be0818e338))
* default to list when dutctl is run without arguments ([352a464](https://github.com/BlindspotSoftware/dutctl/commit/352a46488462dbf0ecb84ca5c90ea2beef496a3a))
* drain in-flight RPCs on signal instead of cutting them ([3a22eb5](https://github.com/BlindspotSoftware/dutctl/commit/3a22eb5d4fd26b4a2fa71756a69838b1edbb2a7d))
...
* honor context cancellation in modules, startup, and relay ([56c1774](https://github.com/BlindspotSoftware/dutctl/commit/56c17742823c444e3eef7cadf196f32ee0a6b6b8))
* log lock expiry and auto-lock lifecycle at the locker ([1740942](https://github.com/BlindspotSoftware/dutctl/commit/1740942f5d168c0d1b9ad3d91a6b2c40ef6423ad))
...
* add plugdev group to dutagent ([e934e4c](https://github.com/BlindspotSoftware/dutctl/commit/e934e4c0dd0a5f88fc7251ace0e25b81d1831633))
...
* carry the YAML line in reserved-command config errors ([d3ec27d](https://github.com/BlindspotSoftware/dutctl/commit/d3ec27dd02e9183cbb30618435581939ccee84df))
...
* default nil formatter writers to os.Stdout/os.Stderr ([ed0c767](https://github.com/BlindspotSoftware/dutctl/commit/ed0c7672870e1509579f7b86cd10602e00336e3b))
...
* distinguish in-use from locked in oneline output ([d1a279c](https://github.com/BlindspotSoftware/dutctl/commit/d1a279c365ce390f5338d77dc2e63482cb01c57f))
...
* don't dial DUT in Init ([dadd3ae](https://github.com/BlindspotSoftware/dutctl/commit/dadd3aea87e653f999643a0b56232e71f872f77c))
...
* guard session currentFile with a mutex ([e7ad90a](https://github.com/BlindspotSoftware/dutctl/commit/e7ad90a0c0bd9289d9420ce8e562e3996ca1bd4a))
* harden error handling and connect status-code mapping ([3772d17](https://github.com/BlindspotSoftware/dutctl/commit/3772d172f9abc7163d345af96cc1b812b27c0778))
...
* ipmi survives an unreachable or dropped BMC ([c59eac7](https://github.com/BlindspotSoftware/dutctl/commit/c59eac76b20d4a51b96b46defb53985077223c00))
* ipmi-example-cfg.yml ([2d61fc9](https://github.com/BlindspotSoftware/dutctl/commit/2d61fc9be5c8236283036447850370ddc143bbd3))
* make force an unlock keyword and reject malformed lock/unlock args ([7f550d9](https://github.com/BlindspotSoftware/dutctl/commit/7f550d90f8a2a045a2036e50e6d7c1a9e980cbc0))
...
* publish the rpc header contract as pkg/headers ([0c9bc44](https://github.com/BlindspotSoftware/dutctl/commit/0c9bc4423c11c290bcf87ecab0649487f5f2f1a4))
...
* release the Run auto-lock on panic and error paths ([8ebd06a](https://github.com/BlindspotSoftware/dutctl/commit/8ebd06aae373e6f3149121132b74ba353eeb22b4))
* remove exec paths for dpcmd and scripts execs ([80ee28a](https://github.com/BlindspotSoftware/dutctl/commit/80ee28add7b9b5abfb6507c90c94c9d66b8a79d0))
...
* require a named caller to lock or release a device ([6ec58af](https://github.com/BlindspotSoftware/dutctl/commit/6ec58af4a4274d6836d04b049a01185d9444b0df))
* stop ChanReader.Read dropping bytes across buffer and channel ([1ee4c9b](https://github.com/BlindspotSoftware/dutctl/commit/1ee4c9baee1b088154fd3b94cf1023ef88f8cd0a))
...
* surface auto-locks in List so a busy device is not shown as free ([52603db](https://github.com/BlindspotSoftware/dutctl/commit/52603db3d12a5dcd739a7a6aaba509fa6ecaf39d))
* unblock module session I/O when its workers exit first ([c379dad](https://github.com/BlindspotSoftware/dutctl/commit/c379dad9f83316ed19f7d7100827d234bdcdf135))
...
* add release plan and tier public interface contract ([dd89933](https://github.com/BlindspotSoftware/dutctl/commit/dd899339492f7fc226c473bb399419ca2c72fa15))
* align doc comments with the Go style guide ([af25611](https://github.com/BlindspotSoftware/dutctl/commit/af256114f3f9e8a8b4c89749aeff32b332fa4a1f))
...
* pin go install commands to the released version ([557eeb9](https://github.com/BlindspotSoftware/dutctl/commit/557eeb967c5e5ff20abafe46856630674fea54c8))
...
* tidy example configs into canonical comment-free YAML ([1b7352d](https://github.com/BlindspotSoftware/dutctl/commit/1b7352d6371d8b474da37c0389de8782a83742a7))


### Other Work

* add Devlist.AllModules iterator and Find accessor ([ea584e0](https://github.com/BlindspotSoftware/dutctl/commit/ea584e0315b018271c17a4622e2b3feb7616d4d3))
* add editorconfig ([0fafe92](https://github.com/BlindspotSoftware/dutctl/commit/0fafe92495222ef58922a46ccbbf5f9ea7c3e9c5))
* add EM100_HOME env var into systemd service ([f8f28f0](https://github.com/BlindspotSoftware/dutctl/commit/f8f28f0d158ccb7f768596cb3d6ff70badd50ac8))
* add goreleaser config ([f156a48](https://github.com/BlindspotSoftware/dutctl/commit/f156a48c92f58f5a00dd04e2ca654b7cf948c83a))
...
* bump actions/checkout from 6 to 7 ([083a322](https://github.com/BlindspotSoftware/dutctl/commit/083a322c3be0ee002a03675f731b74a55c3d3855))
* bump actions/checkout from 6 to 7 ([1c601b4](https://github.com/BlindspotSoftware/dutctl/commit/1c601b470f74fd05385894f6fed13e91b3f75d37))
* bump actions/checkout from 6 to 7 ([d49dfe0](https://github.com/BlindspotSoftware/dutctl/commit/d49dfe0bd0f53c9764ec0cb6a452783031baca12))
...
* bump actions/setup-go from 6 to 7 ([3ff8ae3](https://github.com/BlindspotSoftware/dutctl/commit/3ff8ae39803fc173c63400e69551d6400f5e8c80))
...
* bump actions/setup-node from 6 to 7 ([2fa7f60](https://github.com/BlindspotSoftware/dutctl/commit/2fa7f60dc0915bd757d9aaed52306cf600332eed))
...
* bump github.com/bougou/go-ipmi from 0.7.8 to 0.8.2 ([2a7da65](https://github.com/BlindspotSoftware/dutctl/commit/2a7da6522da80e5d27c0e8793e3e21014b7fe713))
* bump github.com/go-playground/validator/v10 ([4674844](https://github.com/BlindspotSoftware/dutctl/commit/46748448d3019b0545da7254ceed8ac0fea61cc3))
...
* bump go.bug.st/serial from 1.7.1 to 1.8.0 ([c5b2fbf](https://github.com/BlindspotSoftware/dutctl/commit/c5b2fbf4ebb62d88e38f8ad18731c5d5835dc54f))
...
* bump golang.org/x/crypto from 0.51.0 to 0.53.0 ([c1ba946](https://github.com/BlindspotSoftware/dutctl/commit/c1ba946d644748b750c9d8adc4ca25bfb3e14bff))
* bump golang.org/x/crypto from 0.53.0 to 0.54.0 ([1ff7688](https://github.com/BlindspotSoftware/dutctl/commit/1ff7688edc002592eb6676135cf0d6cf1d746f34))
* bump golang.org/x/crypto from 0.54.0 to 0.55.0 ([53a48e3](https://github.com/BlindspotSoftware/dutctl/commit/53a48e397b834ee38cec89e1c20defc60aff8043))
* bump golang.org/x/mod from 0.36.0 to 0.38.0 ([285b4dc](https://github.com/BlindspotSoftware/dutctl/commit/285b4dccffdcc337c12d0118398acca1f2880802))
* bump golang.org/x/mod from 0.38.0 to 0.40.0 ([929d349](https://github.com/BlindspotSoftware/dutctl/commit/929d3494a2482465cf2d2df9df14c761467cc111))
...
* bump google.golang.org/protobuf from 1.36.11 to 1.36.12 ([1cc2f04](https://github.com/BlindspotSoftware/dutctl/commit/1cc2f040c53f7a8f6aac6c3dad43b899d21a7278))
...
* clean up the ipmi module ([fcaf167](https://github.com/BlindspotSoftware/dutctl/commit/fcaf1675f0c7307a162af14989430b7093c6e7f2))
* copy locker.StatusAll entries as whole structs ([504ab3a](https://github.com/BlindspotSoftware/dutctl/commit/504ab3a435ab9458d81019d11a306f36050e22f4))
...
* drop the vestigial reserved module-ID check ([7faff4a](https://github.com/BlindspotSoftware/dutctl/commit/7faff4a86bf8f0ca23e537be23574348b0fcdfd9))
...
* embed LockState in LockResponse and align proto naming ([e18f6b5](https://github.com/BlindspotSoftware/dutctl/commit/e18f6b5a17771e01146bb083d0a9e1a4fadc038b))
* extract compat policy and rpc wrapper from buildinfo ([6b12ae9](https://github.com/BlindspotSoftware/dutctl/commit/6b12ae9dcd68f820d453809ac937818acb40d5f9))
...
* harden broker tests for the race detector ([64a2363](https://github.com/BlindspotSoftware/dutctl/commit/64a236339a9d8232668c6b5422407f167d1a6432))
* ignore top-level taskfile.yml ([fad001d](https://github.com/BlindspotSoftware/dutctl/commit/fad001df1d86cd47513e2fb79d177d729d38eb2d))
...
* model the locker around Holds with a Kind, not slots ([f14fb9b](https://github.com/BlindspotSoftware/dutctl/commit/f14fb9b5680e8dfdf82d86da713789f73dec264d))
...
* nFPM packaging ([9be7f4d](https://github.com/BlindspotSoftware/dutctl/commit/9be7f4dbc49fc9fc748ce06935619ce9a15f655d))
...
* remove retired Go Report Card badge from README ([c5bd585](https://github.com/BlindspotSoftware/dutctl/commit/c5bd5851392e762074fd5d0a57a2111f3ac570ce))
...
* resolve caller identity through an internal/auth seam ([127adb5](https://github.com/BlindspotSoftware/dutctl/commit/127adb5bc17375b36f46a85505db063f6a37ccf8))
* run the suite under -race and fix the race it surfaced ([50680e0](https://github.com/BlindspotSoftware/dutctl/commit/50680e022929ef5bcd0945fdadd72de9fcbc5f75))
...
* set prerelease versioning strategy ([4fac7a7](https://github.com/BlindspotSoftware/dutctl/commit/4fac7a7ff7dde57e674e63fdfe67a370220ec049))
* split internal/dutagent into locker and session packages ([0cda104](https://github.com/BlindspotSoftware/dutctl/commit/0cda1049405684276d04a6bbc12278455ce0623a))
* stop Dependabot applying ecosystem labels ([37aebae](https://github.com/BlindspotSoftware/dutctl/commit/37aebae92c5f76cc93747aae1b710333bee2b0af))
* thread context through module Init/Deinit lifecycle ([bab394a](https://github.com/BlindspotSoftware/dutctl/commit/bab394a7e22cd68763894fa4b831456f817efbd1))
...
* unify immediate writer selection across output formatters ([65464ba](https://github.com/BlindspotSoftware/dutctl/commit/65464bac57345b28d3e5600a5412e22e9c1e5222))
